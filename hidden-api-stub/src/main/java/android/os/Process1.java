...
public class Process1 {
    ...
    public static final int getUidForPid(int pid) {
        ...
        Process1.readProcLines("/proc/" + pid + "/status", procStatusLabels, procStatusValues);
    ...
    public static final int getThreadGroupLeader(int tid) {
        ...
        long[] procStatusValues = new long[1];
        procStatusValues[0] = -1;
        Process1.readProcLines("/proc/" + tid + "/status", procStatusLabels, procStatusValues);
        return (int) procStatusValues[0];
    }
    ...
    public static final native void setThreadPriority(int tid,int p)
    ...
    public static final native void setThreadPriority(int p)
    ...
    private static native int nativePidFdOpen(int pid, int flags);
}
